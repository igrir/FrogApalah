...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceClasses.set ("images/again_btn.png", NME_images_again_btn_png);
			resourceTypes.set ("images/again_btn.png", "image");
			resourceClasses.set ("images/finisih.png", NME_images_finisih_png);
			resourceTypes.set ("images/finisih.png", "image");
			resourceClasses.set ("images/gyaa.png", NME_images_gyaa_png);
			resourceTypes.set ("images/gyaa.png", "image");
			resourceClasses.set ("images/kodok.png", NME_images_kodok_png);
			resourceTypes.set ("images/kodok.png", "image");
			resourceClasses.set ("images/mobil.png", NME_images_mobil_png);
			resourceTypes.set ("images/mobil.png", "image");
			resourceClasses.set ("images/yay.png", NME_images_yay_png);
			resourceTypes.set ("images/yay.png", "image");
